...
while True:
    ...
    if opção == 0:
        ...
        # Resolver o sistema usando o método de Thomas (matriz tridiagonal)
        ...
        print(f'Erro relativo:  {e_medio:.3e}')
        print(f'Erro relativo: {e_max:.3e}')
        print("")
        input("Pressione ENTER para continuar")
